...
import { TreeView, TreeViewItem } from '../remix-ui/tree-view/src'; // eslint-disable-line
import { CopyToClipboard } from '../remix-ui/clipboard/src'; // eslint-disable-line
import { saveAs } from 'file-saver';

import './css/style.css';
import { CustomTooltip } from '../remix-ui/helper/src';
          ...
          {Object.keys(contractProperties).map((propertyName, index) => {
            ...
            const questionMark = (
              <span className="remixui_questionMark">
                <i title={intl.formatMessage({ id: `solidity.${propertyName}`, defaultMessage: help[propertyName] })} className="fas fa-question-circle" aria-hidden="true"></i>
              </span>
            );
