...
import { Toaster } from '../remix-ui/toaster/src'; // eslint-disable-line
import { ModalDialog } from '../remix-ui/modal-dialog/src'; // eslint-disable-line
import { Renderer } from '../remix-ui/renderer/src'; // eslint-disable-line
            ...
            <>
              ...
              {compileErrors[currentFile].error && (
                <Renderer
                  ...
                  plugin={api}
                  opt={{ type: compileErrors[currentFile].error.severity || 'error', errorType: compileErrors[currentFile].error.type }}
                />
              )}
              {compileErrors[currentFile].error &&
