...
import { checkSpecialChars, CustomTooltip, extractNameFromKey } from '../remix-ui/helper/src';
...
import { CopyToClipboard } from '../remix-ui/clipboard/src';
              ...
              >
                <div id="compilerLanguageSelectorWrapper">
                  <select
                    ...
                    style={{ pointerEvents: state.useFileConfiguration ? 'none' : 'auto' }}
                  >
