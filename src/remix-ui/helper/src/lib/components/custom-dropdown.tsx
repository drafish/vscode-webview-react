...
export const CustomToggle = React.forwardRef(
  ({ children, onClick, icon, className = '' }: { children: React.ReactNode; onClick: (e: any) => void; icon: string; className: string }, ref: Ref<HTMLButtonElement>) => (
    <button
      ref={ref}
      onClick={(e) => {
        e.preventDefault();
...
export const CustomIconsToggle = React.forwardRef(
  ({ onClick, icon, className = '' }: { children?: React.ReactNode; onClick: () => void; icon: string; className: string }, ref: Ref<HTMLSpanElement>) => (
    <span
      ref={ref}
      onClick={(e) => {
        e.preventDefault();
...
export const CustomMenu = React.forwardRef(
  (
    ...
    }: { children: React.ReactNode; style?: React.CSSProperties; 'data-id'?: string; className: string; 'aria-labelledby'?: string },
...
export const ProxyAddressToggle = React.forwardRef(
  (
    { address, onClick, className = '', onChange }: { address: string; onClick: (e: any) => void; className: string; onChange: (e: React.ChangeEvent<HTMLInputElement>) => void },
    ref: Ref<HTMLDivElement>,
  ) => (
    <div
      ref={ref}
...
export const ProxyDropdownMenu = React.forwardRef(
  (
    { children, style, className, 'aria-labelledby': labeledBy }: { children: React.ReactNode; style?: React.CSSProperties; className: string; 'aria-labelledby'?: string },
    ref: Ref<HTMLDivElement>,
  ) => {
    return (
